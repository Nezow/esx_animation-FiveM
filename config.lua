...
Config.Animations = {

	{
		...
		label = 'Danse',
		items = {
		    { label = "Danser", type = "anim", data = {lib = "misschinese2_crystalmazemcs1_cs", anim = "dance_loop_tao"}},
		    { label = "Danser stylé", type = "anim", data = {lib = "missfbi3_sniping", anim = "dance_m_default"}},
		    ...
		    { label = "Danse de pecno ", type = "anim", data = {lib = "special_ped@mountain_dancer@monologue_3@monologue_3a", anim = "mnt_dnc_buttwag"}},
		    ...
		    { label = "Danse bisard", type = "anim", data = {lib = "anim@amb@nightclub@lazlow@hi_podium@", anim = "danceidle_mi_15_robot_laz"}},
		    ...
		    { label = "Dance Salsa Roll", type = "anim", data = {lib = "anim@mp_player_intcelebrationmale@salsa_roll", anim = "salsa_roll"}},
		    { label = "Rock'n roll", type =  "anim", data = {lib = "anim@mp_player_intcelebrationmale@rock", anim = "rock"}},
			{ label = "Dance Disco", type = "anim", data = {lib = "anim@mp_player_intcelebrationmale@uncle_disco", anim = "uncle_disco"}},
		}
	},
